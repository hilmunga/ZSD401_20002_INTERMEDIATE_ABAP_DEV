...
*                  )
*               ).
"Old code before using field symbol. Before was using comprehension meaning puting everything in one Item.

"Using field symbols"
"Using field symbol to change values in the flightfield.
  r_result = VALUE #(
               FOR <flight> IN flights_buffer
                 WHERE ( carrier_id = i_carrier_id ) (
                   NEW lcl_passenger_flight(
