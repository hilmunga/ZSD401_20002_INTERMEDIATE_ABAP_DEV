...
CLASS lcl_carrier IMPLEMENTATION.
  ...
  METHOD constructor.
    ...
    me->carrier_id = i_carrier_id.
"Implementation before correction for cds acess control here we are using cds acess control in cds.
*    SELECT SINGLE
*      FROM /lrn/i_carrier
...
*
"Implementation for authorization check which is not available to database direclty because here we use database
  SELECT SINGLE
    FROM /lrn/carrier
