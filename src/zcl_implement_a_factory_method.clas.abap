CLASS zcl_implement_a_factory_method DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS ZCL_IMPLEMENT_A_FACTORY_METHOD IMPLEMENTATION.
...
*        DATA(carrier) = NEW lcl_carrier(  i_carrier_id = c_carrier_id ).
         ...
         DATA(carrier1)  = lcl_carrier=>get_instance(  i_carrier_id = c_carrier_id ).
